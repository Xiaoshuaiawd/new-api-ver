	...
	return func(c *gin.Context) {
		...
		if ok {
			...
			if shouldSelectChannel {
				...
				if preferredChannelID, found := service.SelectCodexUserAgentRoute(c, modelRequest.Model); found {
					codexRouteUsable := false
						...
						if usingGroup == "auto" {
							...
							for _, g := range autoGroups {
								if model.IsChannelEnabledForGroupModel(g, modelRequest.Model, preferred.Id) {
									...
									channel = preferred
									codexRouteUsable = true
									service.MarkCodexUserAgentRouteUsed(c, g, preferred.Id)
									break
								}
							}
							...
							codexRouteUsable = true
							service.MarkCodexUserAgentRouteUsed(c, usingGroup, preferred.Id)
						}
					}
					if !codexRouteUsable {
						service.ClearCodexUserAgentRoute(c)
					}
				}
