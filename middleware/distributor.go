						...
						if usingGroup == "auto" {
							...
							for _, g := range autoGroups {
								if model.IsChannelEnabledForGroupModel(g, modelRequest.Model, preferred.Id) {
									if service.IsChannelAffinityPriorityStale(g, modelRequest.Model, c.Request.URL.Path, preferred.Id) {
							...
							if service.IsChannelAffinityPriorityStale(usingGroup, modelRequest.Model, c.Request.URL.Path, preferred.Id) {
								service.ClearCurrentChannelAffinityCache(c)
							} else {
								channel = preferred
