...
func TestSubscriptionCreationPreservesUserGroupAuthVersionAndSessions(t *testing.T) {
	truncateTables(t)
	...
	require.Empty(t, subscription.PrevUserGroup)
...
func TestLegacySubscriptionGroupCacheRefreshFailureDoesNotChangeCommittedResult(t *testing.T) {
