...
type TaskPrivateData struct {
	...
	SubscriptionPriceAmount float64             `json:"subscription_price_amount,omitempty"` // 订阅售价快照，用于异步计费日志
	SubscriptionAmountTotal int64               `json:"subscription_amount_total,omitempty"` // 订阅总额度快照，用于异步计费日志
...
type TaskBillingContext struct {
	...
	BillingSource   string             `json:"billing_source,omitempty"`    // 提交时的资金来源
}
