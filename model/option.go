...
func InitOptionMap() {
	...
	common.OptionMap["OpenAIUpstreamKeyLimitEnabled"] = strconv.FormatBool(setting.OpenAIUpstreamKeyLimitEnabled)
	common.OptionMap["OpenAIUpstreamKeyLimitConfig"] = setting.OpenAIUpstreamKeyLimitConfig2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "OpenAIUpstreamKeyLimitEnabled":
			setting.OpenAIUpstreamKeyLimitEnabled = boolValue
	...
	case "OpenAIUpstreamKeyLimitConfig":
		err = setting.UpdateOpenAIUpstreamKeyLimitConfigByJSONString(value)
	case "RetryTimes":
