...
type ChannelMultiplierProviderFormat string

const (
	ChannelMultiplierProviderFormatSub2API ChannelMultiplierProviderFormat = "sub2api"
	ChannelMultiplierProviderFormatNewAPI  ChannelMultiplierProviderFormat = "new-api"
)

type ChannelMultiplierMonitorConfig struct {
	Enabled  bool                            `json:"enabled,omitempty"`
	Format   ChannelMultiplierProviderFormat `json:"format,omitempty"`
...
type ChannelOtherSettings struct {
	...
	SupportsImageInput                    *bool                           `json:"supports_image_input,omitempty"`       // 当前渠道是否支持图片输入；nil 表示兼容老渠道，默认支持
	...
	UpstreamKeyMultiplier                 *ChannelMultiplierMonitorConfig `json:"upstream_key_multiplier,omitempty"`
