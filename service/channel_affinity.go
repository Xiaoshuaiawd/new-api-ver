...
func IsChannelAffinityPriorityStale(group string, modelName string, requestPath string, channelID int) bool {
	if channelID <= 0 {
		return false
	}
	...
	return candidate.GetPriority() > preferred.GetPriority()
}
