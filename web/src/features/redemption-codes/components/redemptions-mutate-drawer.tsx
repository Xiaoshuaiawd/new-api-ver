          ...
          >
            <SideDrawerSection>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('Redemption Content')}</FormLabel>
                    <Select
                      value={field.value}
                      onValueChange={(value) => {
                    ...
                    <FormDescription>
                      {t('Choose what users receive after redeeming this code.')}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t('Redeeming this code opens the selected subscription plan.')}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
