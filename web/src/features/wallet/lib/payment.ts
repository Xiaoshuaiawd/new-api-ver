...
/**
 * Check if payment method is Alipay Face-to-Face.
 */
...
export interface PaymentProcessors {
  ...
  alipayF2F: (topupAmount: number) => Promise<boolean>
...
export async function dispatchSelectedPayment(
  ...
  if (isAlipayF2FPayment(paymentMethod.type)) {
    return processors.alipayF2F(topupAmount)
  }
...
export function getDefaultPaymentType(topupInfo: TopupInfo | null): string {
  ...
  if (topupInfo.enable_alipay_f2f_topup) {
    return PAYMENT_TYPES.ALIPAY_F2F
  }
