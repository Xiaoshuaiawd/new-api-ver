...
export const STATIC_I18N_KEYS = [
  ...
  // Referral rewards (section 9-10)
  'registered',
  'first_topup',
  'qualified_first_topup',
  'reward_generated',
  'inviter_settled',
  'invitee',
  'inviter',
  ...
  'Settled rewards',
  'Pending rewards',
  'Qualified first top-ups',
  'First top-up conversion',
  'Reward cost rate',
  'Risk holds',
  'Rewards in review or blocked status',
  'Refund rate',
  'Reward ledger',
  'Risk queue',
  'Daily net revenue and reward cost',
  'Registration to qualified first top-up and settlement',
  'Last 7 days',
  'Last 30 days',
  'This month',
  'Today',
