...
import { Plus, Trash2, GripVertical, ChevronDown, Pencil } from 'lucide-react'
...
export const GroupRatioVisualEditor = memo(function GroupRatioVisualEditor({
  ...
  const handleSimpleEdit = (type: SimpleRatioType, group: SimpleGroup) => {
    setSimpleDialogType(type)
  ...
  const handleSimpleDelete = (type: SimpleRatioType, name: string) => {
    const fieldName =
      type === 'groupRatio'
        ? groupRatio
