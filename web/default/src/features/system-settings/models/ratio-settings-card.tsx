...
const createGroupSchema = (t: Translate) =>
  z.object({
    ...
    SubscriptionGroupRatio: createJsonStringField(t),
...
export function RatioSettingsCard({
  ...
  const groupNormalizedDefaults = useRef({
    ...
    SubscriptionGroupRatio: normalizeJsonString(
      groupDefaults.SubscriptionGroupRatio
    ),
  ...
  const groupForm = useForm<GroupFormValues>({
    ...
    defaultValues: {
      ...
      SubscriptionGroupRatio: formatJsonForTextarea(
        groupDefaults.SubscriptionGroupRatio
      ),
