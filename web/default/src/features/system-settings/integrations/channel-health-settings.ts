...
export const CHANNEL_HEALTH_SETTING_FIELDS = [
  ...
  {
    key: 'slow_first_response_seconds',
    optionKey: 'channel_health_setting.slow_first_response_seconds',
    labelKey: 'Slow first response (seconds)',
    descriptionKey:
      'Reduce a channel weight (never isolate) once its first response is this slow',
    min: 1,
    step: 1,
    group: 'stuck',
  },
...
export const CHANNEL_HEALTH_PRESET_VALUES = {
  conservative: {
    ...
    'channel_health_setting.slow_first_response_seconds': 25,
  ...
  aggressive: {
    ...
    'channel_health_setting.slow_first_response_seconds': 12,
