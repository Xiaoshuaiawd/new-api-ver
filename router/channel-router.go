...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/runtime_health_report", permission: authz.ChannelRead, handler: controller.GetChannelRuntimeHealthReport},
	{method: http.MethodGet, path: "/:id", permission: authz.ChannelRead, handler: controller.GetChannel},
	{method: http.MethodPost, path: "/:id/runtime_action", permission: authz.ChannelOperate, handler: controller.ChannelRuntimeAction},
