...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/model-monitor/self", middleware.HeaderNavModuleAuth("groupMonitor"), controller.GetModelMonitorSelf)
		...
		apiRouter.POST("/alipay-f2f/notify", anonymousRequestBodyLimit, controller.AlipayF2FNotify)
		apiRouter.POST("/subscription/alipay-f2f/notify", anonymousRequestBodyLimit, controller.SubscriptionAlipayF2FNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/alipay-f2f/topup/:tradeNo/status", controller.GetAlipayF2FTopUpStatus)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/alipay-f2f/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestAlipayF2FPay)
			subscriptionRoute.GET("/alipay-f2f/order/:tradeNo/status", controller.GetSubscriptionAlipayF2FOrderStatus)
		...
		logRoute.DELETE("/body-details", middleware.RootAuth(), controller.ClearLogBodyDetails)
		...
		systemTaskRoute.Use(middleware.RootAuth())
		{
			...
			systemTaskRoute.POST("/log-body-cleanup", controller.CreateLogBodyCleanupSystemTask)
